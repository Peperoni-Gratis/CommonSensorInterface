...
public:
    //get sensor readings
    virtual esp_err_t get_readings(T &store) const = 0;
    //get last error generated by the class
    virtual esp_err_t get_last_error() const = 0;
};
...
public:
    ...
    virtual esp_err_t get_sampling_rate(uint64_t &millis) const = 0;
    //check if the sampling is active
    virtual esp_err_t get_sampling_status(bool &sampling_status) const = 0;
};
